        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">درخواست های من</div>
                        ...
                        <table class="table table-responsive table-bordered table-striped">
                            ...
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="{{ route('expert.ticket.show', [$ticket]) }}"><i class="fa fa-list"></i> مشاهده </a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
